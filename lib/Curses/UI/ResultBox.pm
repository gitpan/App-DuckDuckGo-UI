...
#
# *** This file is a heavily customized version of the original Listbox
# allowing multi-line items (results) and some other handly features ***
# ----------------------------------------------------------------------
...
sub draw(;$) {
    ...
    if (not @{$this->{-values}}) {
        ...
        $this->{-canvasscr}->addstr(0,0,'No results.');
